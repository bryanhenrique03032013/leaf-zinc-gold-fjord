...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D1dsfB4S.mjs");
...
var manifest = {
	"1eb384ef09b83fd6fddaee213edb6af65eac98e36a8e0dbab7f93beede048233": {
		functionName: "getProgress_createServerFn_handler",
		importer: () => import("./progress-lrDWgav6.mjs")
	},
	"2c4985e96c199268f7f639534cb5e8e31d6b19d43286bf77416413db60ffde26": {
		functionName: "fetchSessionUser_createServerFn_handler",
		importer: () => import("../__root-dCJWwuOZ.mjs")
	},
	"a511ba3eeec90c26ed864141218723eded09ed746436ae6ccb6084aacfa6951d": {
		functionName: "saveProgress_createServerFn_handler",
		importer: () => import("./progress-lrDWgav6.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BrB2a46J.mjs").then((n) => n.t),
